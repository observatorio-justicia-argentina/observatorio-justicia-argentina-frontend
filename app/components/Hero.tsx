    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <img
          ...
          alt=""
          className="halftone-mask absolute -right-16 top-1/2 h-[110%] w-auto -translate-y-1/2 opacity-[0.34] [filter:grayscale(1)_contrast(1.25)_brightness(1)] sm:-right-8"
        />
